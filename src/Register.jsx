        ...
        <div>
               <div className="flex h-full items-center justify-center md:p-0">
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                    <h2 className="pb-8 text-center text-3xl font-semibold tracking-tight">Sign Up</h2>
                    <form onSubmit={handleRegister} className="flex w-full flex-col items-center justify-center gap-4">
                        ...
                        <button className="uppercase w-[80%] rounded-lg bg-black px-6 py-2 font-medium text-white outline-none  md:w-[60%]" type="submit">
                            sign up
                        </button>
                    </form>
                    {/* divider  */}
                    ...
                    {/* sign with google */}
                    <button className="group mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-black">
