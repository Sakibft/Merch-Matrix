        ...
        <div>
               <div className="flex  items-center justify-center md:p-0 ">
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                    <h2 className="pb-8 text-center text-3xl font-semibold tracking-tight text-green-300">Sign In</h2>
                    <form onSubmit={handleLogin} className="flex w-full flex-col items-center justify-center gap-4">
                        <input
                            className="w-[80%] rounded-lg border border-green-300 bg-transparent py-2 pl-4 text-zinc-600 focus:outline-none focus:ring-2 focus:ring-blue-300/50 md:w-[60%] dark:text-zinc-400"
                            type="email"
                            placeholder="Email"
                            name="email"
                        />
                        ...
                        <p className="text-[14px] text-gray-400">
                            Do not have an account ? <Link to={'/register'} className="text-green-300 underline">Create one</Link>
                        </p>
                        <button className="uppercase w-[80%] rounded-lg bg-green-400 px-6 py-2 font-medium text-white outline-none hover:bg-green-400 md:w-[60%]" type="submit">
                            Submit
                        </button>
                    </form>
                    {/* divider  */}
